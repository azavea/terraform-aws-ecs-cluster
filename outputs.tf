...
output "container_instance_security_group_id" {
  value = join("", aws_security_group.container_instance[*].id)
}

output "container_instance_ecs_for_ec2_service_role_name" {
  value = join("", aws_iam_role.container_instance_ec2[*].name)
}
...
output "container_instance_autoscaling_group_name" {
  value = join("", aws_autoscaling_group.container_instance[*].name)
}
...
output "container_instance_ecs_for_ec2_service_role_arn" {
  value = join("", aws_iam_role.container_instance_ec2[*].arn)
}
